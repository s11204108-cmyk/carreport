...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .form-section input[readonly] { background-color: #f0f0f0; }
...
<div class="container">
    ...
    <div class="form-section">
        <label>現在位置緯度：<input type="number" step="any" id="lat1" placeholder="自動填入" readonly></label>
        <label>現在位置經度：<input type="number" step="any" id="lng1" placeholder="自動填入" readonly></label>
...
<script>
    ...
    let userMarker, marker2, routeLine;
